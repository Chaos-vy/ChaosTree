...
class SplayTest {
    ...
    @Test
    void insertedNodeShouldBecomeRoot() {
        tree.insert(10);
        assertEquals(10, tree.toList(TraversalType.LEVEL_ORDER).getFirst());
    ...
    @Test
    void accessPatternShouldMoveAccessedNodeToRoot() {
        ...
        tree.contains(40);
        assertEquals(40, tree.toList(TraversalType.LEVEL_ORDER).getFirst());

...
class RBTTest {
    ...
    @Test
    void insertAllShouldInsertAllValues() {
    ...
    @Test
    void insertAllShouldThrowOnDuplicate() {
        tree.insert(20);

        assertThrows(DuplicateNodeException.class, () -> tree.insertAll(List.of(10, 20, 30)));
    }
    ...
    @Test
    void containsAllShouldReturnFalseWhenMissingValueExists() {
        tree.insertAll(List.of(10, 20, 30));

        assertFalse(tree.containsAll(List.of(10, 20, 99)));
    }

    @Test
    void deleteAllShouldRemoveSpecifiedValues() {
        tree.insertAll(List.of(10, 20, 30, 40));
    ...
    @Test
    void retainAllShouldKeepIntersectionOnly() {
    ...
    @Test
    void retainAllWithEmptyIterableShouldClearTree() {
        tree.insertAll(List.of(10, 20, 30));

        tree.retainAll(List.of());

        assertTrue(tree.isEmpty());
    }

    @Test
    void mergeAllShouldInsertMissingValues() {
